...
# Set directory and load the data
  dir_data = "../../media/xlin0/share/Data/Nielsen/RMS-Build-2016/"
  module = 1393
  # module = 1340
...
# Movement data  
  ...
  save(all_move, file="../../media/xlin0/share/xl150/move2_1340.RData")
```
...
# Load the macroeconomics data; Merge with dma_move
  load("~/../../media/xlin0/share/xl150/xlin0-dropbox/CPI-SA.RData")
  load("~/../../media/xlin0/share/xl150/xlin0-dropbox/employment.RData")
